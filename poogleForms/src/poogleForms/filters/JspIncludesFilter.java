...
/**
 * Servlet Filter implementation class JspIncludesFilter
 */
@WebFilter(
		filterName = "JspIncludesFilter",
        urlPatterns = {
        		"/allPageFunctionalities.jsp",
        		"/displayAllForms.jsp",
        		"/header.jsp",
        		"/MCQHandler.jsp",
...
public class JspIncludesFilter implements Filter {

    /**
     * Default constructor. 
     */
    public JspIncludesFilter() {
